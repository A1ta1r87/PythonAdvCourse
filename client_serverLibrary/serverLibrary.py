        ...
        while True:
            ...
            if not client_msg:
                ...
                if client_msg == 'exit':
                    ...
                    data_from_library = json.loads(library.national_library.show_all_books())
                elif client_msg == 'given':
                    data_from_library = json.loads(library.national_library.show_given_books())
                elif client_msg == 'available':
                    data_from_library = json.loads(library.national_library.show_available_books())
                    ...
                    if condition in ('T', 'A', 'Y'):
                        ...
                        data_from_library = json.loads(library.national_library.sort_books(parameter))
                    else:
                    ...
                    if reader_id in library.national_library['Readers'].keys():
                        ...
                        if book_id in library.national_library['Books'].keys():
                            book = library.national_library['Books'][book_id][0]
                            author = library.national_library['Books'][book_id][1]
